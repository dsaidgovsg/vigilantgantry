...
def process_frame(cur_img, roi, lane_hitzone, gantry_id, model, endpoint, threshold_value):
    try:
...
def process_video(
    ...
    while True:
        ...
        frame, output = process_frame(
            frame, roi, lane_hitzone, gantry_id, yolo_model, endpoint, threshold_value
        )
